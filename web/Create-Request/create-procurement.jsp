...
<html lang="vi">
    <head>
        ...
        <title>Tạo đề nghị mua hàng - Hệ thống Quản lý Xây dựng</title>
        <!-- CSS Links -->
    ...
    <body>
        ...
        <div class="main-content" id="main-content">
            <div class="page-header">
                <h2><i class="fas fa-shopping-cart"></i> TẠO ĐỀ NGHỊ MUA HÀNG</h2>
                <p class="mb-0">Tạo đề nghị mua hàng cho các hoạt động xây dựng</p>
            </div>
            ...
            <div class="alert alert-danger">
                ...
                Vui lòng chọn ít nhất một vật tư để tạo đề nghị.
                ...
                Vật tư này đã có trong danh sách đề nghị.
                <% } else { %>
                Có lỗi xảy ra: <%= error %>
                <% } %>
            </div>
            ...
            <div class="alert alert-success">
                Tạo đề nghị mua mới thành công!
            </div>
            <% } %>
            ...
            <div class="card">
                <div class="card-header">
                    <i class="fas fa-search"></i> TÌM KIẾM VẬT TƯ
                </div>
                <div class="card-body">
                    <form action="<%= request.getContextPath() %>/procurement-request" method="get" class="search-form">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                <select class="form-select" name="subcategoryFilter">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="<%= request.getContextPath() %>/procurement-request" method="post" style="display: inline;">
            ...
            <div class="card">
                <div class="card-header">
                    <i class="fas fa-file-alt"></i> CHI TIẾT ĐỀ NGHỊ MUA HÀNG
                </div>
                <div class="card-body">
                    <form id="createRequestForm" action="<%= request.getContextPath() %>/procurement-request" method="post">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <% String requestCode = "PR" + String.valueOf(System.currentTimeMillis()).substring(7, 13); %>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-success">
                                ...
                                <tbody>
                                    ...
                                    %>
                                    <tr class="empty-message">
                                        <td colspan="6">Chưa có vật tư nào được chọn.</td>
                                    </tr>
                                    <% 
                                        } else {
                                            int count = 1;
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="generalNote" rows="4" 
                                          placeholder="Nhập ghi chú về lý do mua hàng..."></textarea>
                            </div>
                        </div>

                        <!-- Nút thao tác -->
                        <div class="action-buttons">
                            <a href="<%= request.getContextPath() %>/procurement-request?service=resetForm" 
                               class="btn btn-secondary me-3">
                                <i class="fas fa-undo"></i> Reset lại
                            </a>
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Tạo đề nghị mua hàng
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <script>
                                    function loadSubcategories() {
                                        ...
                                        if (categoryID) {
                                            fetch("<%= request.getContextPath() %>/procurement-request?service=getSubcategories&categoryID=" + categoryID)
